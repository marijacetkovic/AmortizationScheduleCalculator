                                            ...
                                            <div className="card-body">
                                                <div>
                                                    <div style={{ display: "flex" }}>
                                                        ...
                                                        <button onClick={() => this.QSetViewInParent({ page: "editschedule", editnew:  d  })} className="defaultButton">
                                                        ...
                                                        <button onClick={() => this.QSetViewInParent({ page: "auditHistory", auditreqId: d.request_Id })} className="defaultButton">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="16" fill="currentColor" className="bi bi-clock-history" viewBox="0 0 16 16">
